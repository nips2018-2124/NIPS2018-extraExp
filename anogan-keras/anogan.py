...
def generator_model():
    inputs = Input((10,))
    fc1 = Dense(input_dim=10, units=512*2*2)(inputs)
    fc1 = BatchNormalization()(fc1)
    fc1 = LeakyReLU(0.2)(fc1)
    fc2 = Reshape((2, 2, 512), input_shape=(512*2*2,))(fc1)
    # up1 = Conv2DTranspose(512, (4, 4), strides=(1, 1), padding='same')(fc2)
    # conv1 = Conv2D(512, (4, 4), padding='same')(up1)
    # conv1 = BatchNormalization()(up1)
    # conv1 = Activation('relu')(conv1)   # 2*2
    up2 = Conv2DTranspose(256, (4, 4), strides=(2, 2), padding='same')(fc2)
    conv2 = Conv2D(256, (4, 4), padding='same')(up2)
    conv2 = BatchNormalization()(conv2)
    conv2 = Activation('relu')(conv2)   # 4*4
    up3 = Conv2DTranspose(128, (4, 4), strides=(2, 2), padding='same')(conv2)
    conv3 = Conv2D(128, (4, 4), padding='same')(up3)
    conv3 = BatchNormalization()(conv3)
    conv3 = Activation('relu')(conv3)   # 8*8
    up4 = Conv2DTranspose(64, (4, 4), strides=(2, 2), padding='same')(conv3)
    conv4 = Conv2D(64, (4, 4), padding='same')(up4)
    conv4 = BatchNormalization()(conv4)
    conv4 = Activation('relu')(conv4)   # 16*16
    up5 = Conv2DTranspose(3, (4, 4), strides=(2, 2), padding='same')(conv4)
    conv5 = Conv2D(3, (4, 4), padding='same')(up5)
    outputs = Activation('tanh')(conv5)

    model = Model(inputs=[inputs], outputs=[outputs])
    return model

### generator model define for MNIST
# def generator_model():
#     inputs = Input((10,))
...
def discriminator_model():
    ...
    # conv5 = Conv2D(512, (4, 4), strides=(1, 1), padding='same')(conv4)
