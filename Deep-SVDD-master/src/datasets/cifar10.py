...
from datasets.preprocessing import center_data, normalize_data, rescale_to_unit_interval, \
    ...
    get_norm_for_cifar10, get_outlier_for_cifar10
...
class CIFAR_10_DataLoader(DataLoader):
    ...
    def load_data(self, original_scale=False):
        ...
        if Cfg.ad_experiment:
            X_norm,  y_norm = get_norm_for_cifar10()
            ...
            # test set
            X_norm, X_out, y_norm, y_out = get_outlier_for_cifar10()
            ...
            print("Number of outlier data in testing: " + str(np.shape(y_out)[0]))
            print("Number of normal data in testing: " + str(np.shape(y_norm)[0]))
